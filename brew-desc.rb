...
descriptions = {
  ...
  "points2grid" => "Generate digital elevation models (DEM) using a local gridding method",
  ...
  "qcachegrind" => "Visualization tool for profiling data generated by Cachegrind and Calltree",
  ...
  "rest-shell" => "Shell to interact with Spring HATEOAS-compliant REST resources",
