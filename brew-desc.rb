...
descriptions = {
  ...
  "pax-construct" => "scripts, tools and plugins to help setup and develop quick OSGi projects and demos",
  "pax-runner" => "",
  ...
  "pdf2ipe" => "Drawing editor for creating figures in PDF/Postscript format",
  ...
  "s-lang" => "Multi-platform programmer's library designed to create multi-platform software",
  ...
  "saga-core" => "Distributed computing standard",
  ...
  "scm-manager" => "Manage Git, Mercurial and Subversion repositories over http",
  ...
  "simgrid" => "Ccientific instrument to study the behavior of large-scale distributed systems",
  ...
  "solid" => "Library for collision detection of geometric objects in 3D space",
  ...
  "speedtest_cli" => "Command line interface for testing internet bandwidth using speedtest.net",
  ...
  "sproxy" => "HTTP proxy server that collects URLs in a “siege-friendly” manner",
  "sqlcipher" => "Extension to SQLite that provides 256-bit AES encryption of database files",
  "sqlite" => "Command line interface for SQLite",
  "sqliteman" => "GUI tool for Sqlite3",
  "sqoop" => "Tool to transfer bulk data between Apache Hadoop and structured datastores",
  "sqsh" => "Sybase Shell",
