...
descriptions = {
  ...
  "docbook-xsl" => "An XML vocabulary for creating presentation-neutral documents",
  ...
  "dvorak7min" => "A Dvorak (simplified keyboard layout) typing tutor",
  ...
  "easy-git" => "Tutorial-oriented Git focused on simplicity and learnability",
