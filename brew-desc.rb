...
descriptions = {
  ...
  # "abcmidi" => "",
  "abiword" => "AbiWord is a free word processing program similar to MS Word",
  "abnfgen" => "Quickly generates random documents that match an ABFN grammar",
  ...
  "ansifilter" => "Utility to strip or convert ANSI codes into HTML, (La)Tex, RTF or BBCode",
  "antiword" => "Utility to read Word (.doc) files",
  "antlr" => "ANTLR: ANother Tool for Language Recognition",
  "anttweakbar" => "A small and easy to use C/C++ library for adding GUI's to OpenGL apps",
  ...
  "aplus" => "A+ is a powerful and efficient programming language",
  "apollo" => "Apollo is a multi-protocol messaging broker based on ActiveMQ",
  ...
  "appswitch" => "a command-line interface to OS X process management",
  "apt-dater" => "ncurses frontend for managing package updates on remote hosts using SSH",
  ...
  "arm" => "a terminal status monitor for Tor,",
  "armadillo" => "a C++ linear algebra library (matrix maths)",
  ...
  "arss" => "a program that analyses a sound file into a spectrogram",
  ...
  "asciitex" => "program to generate ASCII-art representations of mathematical equations",
  "asm6" => "6502 assembler",
  "asn1c" => "open source compiler of ASN.1 specifications into C source code",
  ...
  "atkmm" => "the official C++ interface for the ATK accessibility toolkit library",
