...
descriptions = {
  ...
  "ezlupdate" => "ezlupdate is the general way to create .ts files for eZ publish",
  "ezstream" => "Ezstream is a command line source client for Icecast streaming servers",
  "f3" => "Tests various flash cards, similar to h2test",
  ...
  "fakeroot" => "fakeroot provides a fake root environment",
  ...
  "fbida" => "applications for viewing and editing images focussed on photos",
  "fceux" => "NES and Famicom Emulator",
  "fcgi" => "FastCGI is a protocol for interfacing interactive programs with a web server",
  "fcgiwrap" => "Simple CGI support for Nginx",
  "fcrackzip" => "Fcrackzip is a zip password cracker",
  ...
  "fetch-crl" => "Retrieves certificate revocation lists (CRLs)",
  "fex" => "Fex is a powerful field extraction tool",
  "ffind" => "A friendlier find",
  ...
  "ffmpegthumbnailer" => "Creates thumbnails for your video files",
  ...
  "figtoipe" => "converts figures made with Xfig to Ipe's XML format",
  "finch" => "Finch is a console-based Instant Messenger",
  ...
  "flare" => "A distributed, and persistent key-value storage compatible with memcached",
  ...
  "fluid-synth" => "A real-time software synthesizer based on the SoundFont 2 specifications",
  ...
  "freeradius-server" => "A high-performance and highly configurable RADIUS server",
  "freerdp" => "A free RDP (Remote Desktop Protocol) implementation",
  ...
  "freexl" => "open source library to extract data from Excel .xls files",
  ...
  "garmintools" => "A Linux interface to the Garmin Forerunner GPS units",
  ...
  "gcutil" => "A command-line tool to manage your Google Compute Engine resources",
