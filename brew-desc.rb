...
descriptions = {
  ...
  "colloquypush" => "Modules to add push support to Colloquy Mobile",
  ...
  "gnutls2" => "Secure communications library (SSL, TLS and DTLS protocols)",
  ...
  "ruby-enterprise-edition" => "Optimized Ruby implementation",
  # "ruby-odbc" => "",
  # "runcocoa" => "",
