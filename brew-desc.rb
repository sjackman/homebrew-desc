...
descriptions = {
  ...
  "jemalloc" => "malloc implementation that emphasizes fragmentation avoidance and scalable concurrency support",
  ...
  "leveldb" => "Key-value storage library with ordered mapping from keys to values",
  ...
  "libgtextutils" => "Tools for Short-Reads FASTA/FASTQ files preprocessing",
  ...
  "libnids" => "Implements an E-component of Network Intrusion Detection System",
  ...
  "libpano" => "Tool to build panoramic images from a set of overlapping images",
  ...
  "librets" => "C++ library implementing RETS standards",
  ...
  "libspatialite" => "Library extending SQLite to support spatial SQL capabilities",
  ...
  "libstfl" => "Library implementing a curses-based widget set for text terminals",
  ...
  "libwbxml" => "Library and associated tools to parse and encode WBXML documents",
  ...
  "mp3fs" => "Read-only FUSE filesystem which transcodes audio formats to MP3 on the fly",
  ...
  "postgres-xc" => "Multi-master write-scalable PostgreSQL cluster based on shared-nothing architecture",
  ...
  "pplatex" => "",
  "ppss" => "Shell script that executes commands, scripts or programs in parallel",
  ...
  "prooftree" => "Program for proof-tree visualization during interactive proof development in a theorem prover",
  ...
  "rbenv-readline" => "Rbenv plugin to automatically link Ruby installs to readline",
  "rbenv-use" => "Rbenv plugin that makes switching between Ruby versions easier",
  "rbenv-vars" => "Rbenv plugin that safely sets global and per-project environment variables",
  "rbenv-whatis" => "Rbenv plugin resolves abbreviations and aliases to Ruby versions",
  ...
  "reattach-to-user-namespace" => "Reattach process (ex. tmux) to OSX background bootstrap",
  ...
  "remctl" => "Client/server application for remote execution of specific tasks",
  ...
  "scrypt" => "Encrypt and decrypt files using memory-hard password key-derivation function",
  "scsh" => "Scheme shell",
  ...
  "shark" => "Fast, modular, feature-rich open-source C++ machine learning library",
  "shell.fm" => "Lightweight console-based radio player for Last.FM radio streams",
  "shellinabox" => "Export command line tools to a web based terminal emulator",
  "shiboken" => "",
  ...
  "shmux" => "Program for executing the same command on many hosts in parallel",
  ...
  "sslh" => "Forward connections based on the first data packet sent by client",
  ...
  "style-check" => "",
  "sub2srt" => "Tool to convert subtitles from .sub to subviewer .srt format",
  ...
  "tcptrack" => "Tool to monitor the status of TCP connections on a given network interface",
  "tcpurify" => "",
  "teapot" => "",
  "tee-clc" => "",
  "teem" => "Group of libraries for representing, processing, and visualizing scientific raster data",
  "tenyr" => "32-bit computing environment with focus on simplicity of design and implementation",
  "term" => "",
  ...
  "unfs3" => "",
  "unifdef" => "Tool that selectively processes conditional C preprocessor #if and #ifdef directives",
  ...
  "vde" => "",
  "vera++" => "Programmable tool for verification, analysis and transformation of C++ source code",
  ...
  "vgmstream" => "Library for playing a wide variety of streamed audio formats used in video games",
  ...
  "virtualhost.sh" => "Script for Mac OS X to create virtual hosts under Apache",
