...
descriptions = {
  ...
  "htmlcompressor" => "A small, fast Java library that minifies HTML or XML source",
  "htmlcxx" => "",
  "htmldoc" => "Convert HTML to PDF or PostScript",
  "htop-osx" => "A better top (interactive process viewer) for OSX",
  "htpdate" => "",
  "http_load" => "",
  ...
  "libsodium" => "A portable version of Daniel Bernstein's NaCl networking and cryptography library",
  "libsoup" => "",
  "libspatialite" => "",
  "libspiro" => "",
  "libspotify" => "",
  ...
  "p11-kit" => "A library to load and enumerate PKCS# 11 modules",
