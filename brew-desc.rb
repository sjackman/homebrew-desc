...
descriptions = {
  ...
  "ld64" => "ld64 is an updated version of the ld shipped by Apple",
  ...
  "libtextcat" => "Library that implements the 'N-Gram-Based Text Categorization' classification technique",
  ...
  "lxsplit" => "Tool for splitting files and joining the splitted files",
  "lynx" => "Text-based web browser",
  "lysp" => "Lisp interpreter",
  ...
  "matlab2tikz" => "MATLAB(R) script for converting MATLAB(R) figures into native TikZ/Pgfplots figures",
