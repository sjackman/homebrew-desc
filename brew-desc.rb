...
descriptions = {
  ...
  "ical-buddy" => "Utility to get a lists of events and tasks from the OS X calendar database",
  ...
  "idcomments" => "Extract comments from an internet-draft with interspersed review comments",
