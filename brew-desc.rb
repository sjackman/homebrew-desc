...
descriptions = {
  ...
  "multimarkdown" => "Tool to turn marked-up plain text into well formatted documents",
  ...
  "unar" => "The unarchiver command line tools",
  ...
  "valkyrie" => "GUI for the Memcheck and Helgrind tools in the Valgrind 3.6.X line",
  ...
  "wrangler" => "Interactive refactoring tool for Erlang, integrated into emacs and Eclipse",
