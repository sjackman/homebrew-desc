...
descriptions = {
  ...
  "mogenerator" => "Generates Objective-C code for core data custom classes",
  ...
  "mosquitto" => "Message broker that implements the MQ telemetry transport protocol",
  ...
  "mplayershell" => "An improved visual experience for MPlayer on OS X",
  ...
  "msgpack-rpc" => "Inter-process messaging library that uses MessagePack for object serialization",
  ...
  "mu" => "Tool for dealing with e-mail messages stored in the maildir-format",
  ...
  "nesc" => "",
  "net-snmp" => "Applications to implement SNMP v1, SNMP v2c and SNMP v3 using IPv4 and IPv6",
  "net6" => "",
  ...
  "objective-caml" => "General purpose programming language",
  ...
  "open-mesh" => "Generic data structure for representing and manipulating polygonal meshes",
  "open-mpi" => "",
  ...
  "osm-pbf" => "",
  "osm2pgsql" => "Program to convert OpenStreetMap data to postGIS-enabled PostgreSQL databases",
