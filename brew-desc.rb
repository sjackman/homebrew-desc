...
<<<<<<< HEAD
  ...
  "alac" => "alac is a basic decoder for Apple Lossless Audio Codec files (ALAC)",
  ...
  "alure" => "A utility library to help manage common tasks with OpenAL applications.",
=======
  "abcl" => "Armed Bear Common Lisp (ABCL): a full implementation of the Common Lisp language featuring both an interpreter and a compiler, running in the JVM. Originally started to be a scripting language for the J editor, it now supports JSR-223 (Java scripting API): it can be a scripting engine in any Java application. Additionally, it can be used to implement (parts of) the application using Java to Lisp integration APIs.",
  # "abcmidi" => "",
  "abiword" => "AbiWord is a free word processing program similar to Microsoft® Word.",
  "abnfgen" => "Given an Augmented Backus-Naur form (ABNF) grammar (Wikipedia, RFC 4234), abnfgen quickly generates lots of random documents that match that grammar.",
  "abook" => "Address book with mutt support",
  "ace" => "The ADAPTIVE Communication Environment (ACE(TM)): An OO Network Programming Toolkit in C++",
  "ack" => "ack is a tool like grep, optimized for programmers",
  ...
  "adobe-air-sdk" => "Adobe® AIR® provides developers with a consistent and flexible development environment for the delivery of out-of-browser applications and games across devices and platforms (Windows, Mac, iOS, Android).",
  "adol-c" => "ADOL-C (Automatic Differentiation by OverLoading in C++) facilitates the evaluation of first and higher derivatives of vector functions that are defined by computer programs written in C or C++.",
  "adplug" => "AdPlug is a free, cross-platform, hardware independent AdLib sound player library, mainly written in C++ and released under the LGPL.",
  "advancecomp" => "Recompression utilities for .PNG, .MNG, .ZIP and .GZ files",
  "aescrypt" => "A program for encryption/decryption",
  "aespipe" => "aespipe program is for AES encrypting or decrypting a pipe. It reads from standard input and writes to standard output.",
  "afflib" => "The Advanced Forensic Format",
  "afsctool" => "Utility for manipulating HFS+ compressed files",
  "aften" => "Aften is an audio encoder which generates compressed audio streams based on ATSC A/52 specification.",
  "afuse" => "afuse is an automounting file system implemented in user-space using FUSE.",
  "aget" => "Multithreaded HTTP download accelerator",
  # "aggregate" => "",
  "aiccu", => "AICCU (Automatic IPv6 Connectivity Client Utility) makes it easy for users to get IPv6 connectivity.",
  "aimage" => "Advanced Disk Imager",
  "aircrack-ng" => "Next-generation aircrack with lots of new features",
  ...
  "alac" => "alac is a basic decoder for Apple Lossless Audio Codec files (ALAC).",
  "aldo" => "Aldo is a morse code learning tool released under GPL",
  "algol68g" => "Algol 68 Genie is a fast compiler-interpreter which ranks among the most complete implementations of the language; it supports for instance partial parametrisation, parallel processing, formatted transput and a refinement preprocessor.",
  "alpine" => "A program for Internet news and email",
  "alure" => "ALURE is a utility library to help manage common tasks with OpenAL applications.",
>>>>>>> 38e49c04138d0948a0236495cff10bfd893eb814
  "amap" => "A tool to perform application protocol detection.",
  # "android-ndk" => "",
  # "android-sdk" => "",
  # "ann" => "",
  # "ansifilter" => "",
  ...
  "pow" => "A zero-config Rack server for local apps on Mac OS X",
